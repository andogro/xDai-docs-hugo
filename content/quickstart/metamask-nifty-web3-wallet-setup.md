...
1. Download Nifty Wallet or Metamask  
   {{% alert theme="warning" %}}**Do not enable both wallets at the same time.** as there can be conflicts between the two. Apps can be enabled/disabled in the chrome extensions interface. {{% /alert %}}
